...
int j = 3;
int k = 0;
double uemax = 0.5; //also at the thing
double t_end = 2.5;// also at the tihng
...
double MUl = 5.e-3;//MUl[4] = {2.e-2, 5.e-3, 5.e-3, 5.e-3}; //5.e-3
double MUg = 2.5e-2; //MUg[4] = {1.e-1, 2.5e-2, 2.5e-2, 2.5e-2}; //2.5e-2
double Ul = 0.5;//Ul[4] = {2, 2, 1, 0.5}; //0.5
double Ug = 160/3;//Ug[4] = {40/3, 160/3, 160/3, 160/3}; //160
double theta0 = 70;//theta0[3] = {70, 30, 90}; //70
...
// Left boundary
u.n[left] = dirichlet(fabs(y) < (d/2 + 0.1) ? Ul : Ug);
u.t[left] = neumann(0);
