...
#line 22 "/Users/ethansmith/basilisk/src/grid/config.h"
# define OMP(x)
...
#line 76 "/Users/ethansmith/basilisk/src/grid/config.h"
...
# define tracing(...)
# define end_tracing(...)
#line 367 "/Users/ethansmith/basilisk/src/grid/config.h"
static bool in_prof = false;
static double prof_start, _prof;
#define prof_start(name)\
  if (!(!in_prof)) qassert ("/Users/ethansmith/basilisk/src/grid/config.h", 370, "!in_prof"); in_prof = true;\
  prof_start = MPI_Wtime();\

#line 372

#define prof_stop()\
  if (!(in_prof)) qassert ("/Users/ethansmith/basilisk/src/grid/config.h", 374, "in_prof"); in_prof = false;\
  _prof = MPI_Wtime();\
...
{tracing("mpi_all_reduce0","/Users/ethansmith/basilisk/src/grid/config.h",384);
  { int _ret= MPI_Allreduce (sendbuf, recvbuf, count, datatype, op, comm);end_tracing("mpi_all_reduce0","/Users/ethansmith/basilisk/src/grid/config.h",387);return _ret;}
end_tracing("mpi_all_reduce0","/Users/ethansmith/basilisk/src/grid/config.h",388);}
...
#line 500 "/Users/ethansmith/basilisk/src/grid/config.h"
  }
}
#line 513 "/Users/ethansmith/basilisk/src/grid/config.h"
...
#line 1091 "/Users/ethansmith/basilisk/src/output.h"
     
void dump (const char * file,
    scalar * list,
    FILE * fp,
    bool unbuffered)
{tracing("dump","/Users/ethansmith/basilisk/src/output.h",1092);
...
end_tracing("dump","/Users/ethansmith/basilisk/src/output.h",1165);}
...
#line 1315 "/Users/ethansmith/basilisk/src/output.h"
  scalar * other = NULL;
  {scalar*_i=(scalar*)( all);if(_i)for(scalar s=*_i;(&s)->i>=0;s=*++_i){
...
#line 322 "/Users/ethansmith/basilisk/src/view.h"
typedef struct {
  GLubyte a[4];
} RGBA;
...
{tracing("compose_image","/Users/ethansmith/basilisk/src/view.h",336);
  unsigned char * image = framebuffer_image (view->fb);
  if (!(image)) qassert ("/Users/ethansmith/basilisk/src/view.h", 339, "image");
  if (npe() > 1) {
    MPI_Op op;
  ...
  {end_tracing("compose_image","/Users/ethansmith/basilisk/src/view.h",354);return image;}
end_tracing("compose_image","/Users/ethansmith/basilisk/src/view.h",355);}
...
#line 644 "/Users/ethansmith/basilisk/src/view.h"
 ...
 clear();
    ...
    parse_params ((Params[]){{"file", pstring, &file}, {NULL}});
    dump ( file
#line 1092 "/Users/ethansmith/basilisk/src/output.h"
, 
all, 
NULL, 
false
...
{tracing("tag","/Users/ethansmith/basilisk/src/tag.h",62);
  ...
  _attribute[t.i].dirty = true;
#line 82 "/Users/ethansmith/basilisk/src/tag.h"
  scalar  index=new_scalar("index");
  z_indexing (index, true);
  foreach_stencil(1,{0},)
    {_stencil_val(t,0,0,0);_stencil_val(index,0,0,0);_stencil_val_a(t,0,0,0);      }end_foreach_stencil()
   BEGIN_FOREACH{
#line 84
foreach()
    val(t,0,0,0) = (val(t,0,0,0) != 0)*(val(index,0,0,0) + 1);end_foreach();}END_FOREACH 
#line 99 "/Users/ethansmith/basilisk/src/tag.h"
  bool changed;
  do {
...
#line 222 "/Users/ethansmith/basilisk/src/tag.h"
  long lmax = a->len;
...
foreach()
  ...
  array_free (a);
  {delete((scalar*)((scalar[]){index,{-1}}));{end_tracing("tag","/Users/ethansmith/basilisk/src/tag.h",268);return n;}}delete((scalar*)((scalar[]){index,{-1}}));
...
static double _boundary16(Point point,Point neighbor,scalar _s,bool *data){int ig=0;NOT_UNUSED(ig);int jg=0;NOT_UNUSED(jg);POINT_VARIABLES;{int ig=neighbor.i-point.i;if(ig==0)ig=_attribute[_s.i].d.x;NOT_UNUSED(ig);int jg=neighbor.j-point.j;if(jg==0)jg=_attribute[_s.i].d.y;NOT_UNUSED(jg);POINT_VARIABLES;{return( _dirichlet(0, point, neighbor, _s, data));}}}static double _boundary16_homogeneous(Point point,Point neighbor,scalar _s,bool *data){int ig=0;NOT_UNUSED(ig);int jg=0;NOT_UNUSED(jg);POINT_VARIABLES;{int ig=neighbor.i-point.i;if(ig==0)ig=_attribute[_s.i].d.x;NOT_UNUSED(ig);int jg=neighbor.j-point.j;if(jg==0)jg=_attribute[_s.i].d.y;NOT_UNUSED(jg);POINT_VARIABLES;{return( _dirichlet_homogeneous(0, point, neighbor, _s, data));}}}
static double _boundary17(Point point,Point neighbor,scalar _s,bool *data){int ig=0;NOT_UNUSED(ig);int jg=0;NOT_UNUSED(jg);POINT_VARIABLES;{int ig=neighbor.i-point.i;if(ig==0)ig=_attribute[_s.i].d.x;NOT_UNUSED(ig);int jg=neighbor.j-point.j;if(jg==0)jg=_attribute[_s.i].d.y;NOT_UNUSED(jg);POINT_VARIABLES;{return( _dirichlet(0, point, neighbor, _s, data));}}}static double _boundary17_homogeneous(Point point,Point neighbor,scalar _s,bool *data){int ig=0;NOT_UNUSED(ig);int jg=0;NOT_UNUSED(jg);POINT_VARIABLES;{int ig=neighbor.i-point.i;if(ig==0)ig=_attribute[_s.i].d.x;NOT_UNUSED(ig);int jg=neighbor.j-point.j;if(jg==0)jg=_attribute[_s.i].d.y;NOT_UNUSED(jg);POINT_VARIABLES;{return( _dirichlet_homogeneous(0, point, neighbor, _s, data));}}}

static double _boundary18(Point point,Point neighbor,scalar _s,bool *data){int ig=0;NOT_UNUSED(ig);int jg=0;NOT_UNUSED(jg);POINT_VARIABLES;{int ig=neighbor.i-point.i;if(ig==0)ig=_attribute[_s.i].d.x;NOT_UNUSED(ig);int jg=neighbor.j-point.j;if(jg==0)jg=_attribute[_s.i].d.y;NOT_UNUSED(jg);POINT_VARIABLES;{return( _dirichlet(0, point, neighbor, _s, data));}}}static double _boundary18_homogeneous(Point point,Point neighbor,scalar _s,bool *data){int ig=0;NOT_UNUSED(ig);int jg=0;NOT_UNUSED(jg);POINT_VARIABLES;{int ig=neighbor.i-point.i;if(ig==0)ig=_attribute[_s.i].d.x;NOT_UNUSED(ig);int jg=neighbor.j-point.j;if(jg==0)jg=_attribute[_s.i].d.y;NOT_UNUSED(jg);POINT_VARIABLES;{return( _dirichlet_homogeneous(0, point, neighbor, _s, data));}}}
static double _boundary19(Point point,Point neighbor,scalar _s,bool *data){int ig=0;NOT_UNUSED(ig);int jg=0;NOT_UNUSED(jg);POINT_VARIABLES;{int ig=neighbor.i-point.i;if(ig==0)ig=_attribute[_s.i].d.x;NOT_UNUSED(ig);int jg=neighbor.j-point.j;if(jg==0)jg=_attribute[_s.i].d.y;NOT_UNUSED(jg);POINT_VARIABLES;{return( _dirichlet(0, point, neighbor, _s, data));}}}static double _boundary19_homogeneous(Point point,Point neighbor,scalar _s,bool *data){int ig=0;NOT_UNUSED(ig);int jg=0;NOT_UNUSED(jg);POINT_VARIABLES;{int ig=neighbor.i-point.i;if(ig==0)ig=_attribute[_s.i].d.x;NOT_UNUSED(ig);int jg=neighbor.j-point.j;if(jg==0)jg=_attribute[_s.i].d.y;NOT_UNUSED(jg);POINT_VARIABLES;{return( _dirichlet_homogeneous(0, point, neighbor, _s, data));}}}




static double _boundary20(Point point,Point neighbor,scalar _s,bool *data){int ig=0;NOT_UNUSED(ig);int jg=0;NOT_UNUSED(jg);POINT_VARIABLES;{int ig=neighbor.i-point.i;if(ig==0)ig=_attribute[_s.i].d.x;NOT_UNUSED(ig);int jg=neighbor.j-point.j;if(jg==0)jg=_attribute[_s.i].d.y;NOT_UNUSED(jg);POINT_VARIABLES;{return( _dirichlet(fabs(y) < (d/2 + 0.1) ? 1 : 0, point, neighbor, _s, data));}}}static double _boundary20_homogeneous(Point point,Point neighbor,scalar _s,bool *data){int ig=0;NOT_UNUSED(ig);int jg=0;NOT_UNUSED(jg);POINT_VARIABLES;{int ig=neighbor.i-point.i;if(ig==0)ig=_attribute[_s.i].d.x;NOT_UNUSED(ig);int jg=neighbor.j-point.j;if(jg==0)jg=_attribute[_s.i].d.y;NOT_UNUSED(jg);POINT_VARIABLES;{return( _dirichlet_homogeneous(fabs(y) < (d/2 + 0.1) ? 1 : 0, point, neighbor, _s, data));}}}


static double _boundary21(Point point,Point neighbor,scalar _s,bool *data){int ig=0;NOT_UNUSED(ig);int jg=0;NOT_UNUSED(jg);POINT_VARIABLES;{int ig=neighbor.i-point.i;if(ig==0)ig=_attribute[_s.i].d.x;NOT_UNUSED(ig);int jg=neighbor.j-point.j;if(jg==0)jg=_attribute[_s.i].d.y;NOT_UNUSED(jg);POINT_VARIABLES;{return( _dirichlet(0, point, neighbor, _s, data));}}}static double _boundary21_homogeneous(Point point,Point neighbor,scalar _s,bool *data){int ig=0;NOT_UNUSED(ig);int jg=0;NOT_UNUSED(jg);POINT_VARIABLES;{int ig=neighbor.i-point.i;if(ig==0)ig=_attribute[_s.i].d.x;NOT_UNUSED(ig);int jg=neighbor.j-point.j;if(jg==0)jg=_attribute[_s.i].d.y;NOT_UNUSED(jg);POINT_VARIABLES;{return( _dirichlet_homogeneous(0, point, neighbor, _s, data));}}}
...
double geometry (double x, double y) {
 ...
 coord inner_top_triangle_coords[] = {
  {vert_coord.x - vertical_width/2 + 3/2*vertical_width, center.y + d/2},
...
foreach_vertex () {
 ...
 boundary_internal ((scalar *)((scalar[]){phi,{-1}}), "blur-ibm.c", 260);
   fractions (phi, c
...
#line 308 "blur-ibm.c"
 ...
 k=0;
    ...
    const scalar cc = new_const_scalar("cc",14, theta0[k]*3.14159265358979/180);
    contact_angle = cc;
    run();
 num=0;
...
#line 337
      static int init_0(const int i,const double t,Event *_ev){tracing("init_0","blur-ibm.c",337); {

 if (!restore("dump-1.275"
#line 1169 "/Users/ethansmith/basilisk/src/output.h"
, 
NULL, 
NULL
#line 339 "blur-ibm.c"
    ...
    do {
      ...
      solid_domain (cs, fs);
      ss = adapt_wavelet (
#line 349 "/Users/ethansmith/basilisk/src/grid/tree-common.h"
(
#line 173
scalar *
#line 349
...
val(u.y,0,0,0) = 0;
 ...
 solid_domain (cs, fs);
 boundary_internal ((scalar *)all, "blur-ibm.c", 365);
}{end_tracing("init_0","blur-ibm.c",366);return 0;}end_tracing("init_0","blur-ibm.c",366);}
...
#line 368
      static int logfile(const int i,const double t,Event *_ev){tracing("logfile","blur-ibm.c",368); {
 fflush(fout);
...
foreach_point(0, 0)
  ...
  fclose(fp0);
}{end_tracing("logfile","blur-ibm.c",390);return 0;}end_tracing("logfile","blur-ibm.c",390);}
...
#line 392
      static int interface(const int i,const double t,Event *_ev){tracing("interface","blur-ibm.c",392); {
  char name[80];
...
#line 396 "blur-ibm.c"
  ...
  fclose (fpi);
}{end_tracing("interface","blur-ibm.c",398);return 0;}end_tracing("interface","blur-ibm.c",398);}

static int snapshot_expr0(int *ip,double *tp,Event *_ev){int i=*ip;double t=*tp;int ret=(t += 0.025)!=0;*ip=i;*tp=t;return ret;}


#line 400
      static int snapshot(const int i,const double t,Event *_ev){tracing("snapshot","blur-ibm.c",400); {
...
#line 435 "blur-ibm.c"
  ...
  cells(
#line 1121 "/Users/ethansmith/basilisk/src/draw.h"
(coord) {0,0,1}, 0.,
(
...
#line 437 "blur-ibm.c"
  ...
  fclose (fp4);delete((scalar*)((scalar[]){umag,omega,{-1}}));
}{end_tracing("snapshot","blur-ibm.c",439);return 0;}end_tracing("snapshot","blur-ibm.c",439);}
...
#line 441
      static int movie(const int i,const double t,Event *_ev){tracing("movie","blur-ibm.c",441); {
...
#line 450 "blur-ibm.c"
  ...
  fclose (fp1);
  num++;
}{end_tracing("movie","blur-ibm.c",453);return 0;}end_tracing("movie","blur-ibm.c",453);}

static int adapt_0_expr0(int *ip,double *tp,Event *_ev){int i=*ip;double t=*tp;int ret=(i++)!=0;*ip=i;*tp=t;return ret;}


#line 455
      static int adapt_0(const int i,const double t,Event *_ev){tracing("adapt_0","blur-ibm.c",455); {
  adapt_wavelet (
#line 456 "/Users/ethansmith/basilisk/src/grid/tree-common.h"
(
#line 173
scalar *
#line 456
...
}{end_tracing("droplets","blur-ibm.c",463);return 0;}end_tracing("droplets","blur-ibm.c",463);}

static int dumps_expr0(int *ip,double *tp,Event *_ev){int i=*ip;double t=*tp;int ret=( t <= t_end)!=0;*ip=i;*tp=t;return ret;}static int dumps_expr1(int *ip,double *tp,Event *_ev){int i=*ip;double t=*tp;int ret=(i += 50)!=0;*ip=i;*tp=t;return ret;}


#line 465
      static int dumps(const int i,const double t,Event *_ev){tracing("dumps","blur-ibm.c",465);{
 scalar * dumplist =((scalar[]) {u.x,u.y,p,f,cs,{-1}});
 char name[80];
 sprintf(name, "dumps/dump-%g", t);
 dump ( name, dumplist
#line 1093 "/Users/ethansmith/basilisk/src/output.h"
, 
NULL, 
false
#line 469 "blur-ibm.c"
...
}{end_tracing("dumps","blur-ibm.c",471);return 0;}end_tracing("dumps","blur-ibm.c",471);}
...
#line 337 "blur-ibm.c"
event_register((Event){0,1,init_0,{init_0_expr0},((int *)0),((double *)0),"blur-ibm.c",337,"init"});  
#line 368
event_register((Event){0,2,logfile,{logfile_expr0,logfile_expr1},((int *)0),((double *)0),"blur-ibm.c",368,"logfile"});  
#line 392
event_register((Event){0,2,interface,{interface_expr0,interface_expr1},((int *)0),((double *)0),"blur-ibm.c",392,"interface"});  
...
event_register((Event){0,1,snapshot,{snapshot_expr0},((int *)0),((double *)0),"blur-ibm.c",400,"snapshot"});  
#line 441
event_register((Event){0,2,movie,{movie_expr0,movie_expr1},((int *)0),((double *)0),"blur-ibm.c",441,"movie"});  
#line 461
event_register((Event){0,1,droplets,{droplets_expr0},((int *)0),((double *)0),"blur-ibm.c",461,"droplets"});  



event_register((Event){0,2,dumps,{dumps_expr0,dumps_expr1},((int *)0),((double *)0),"blur-ibm.c",465,"dumps"});
...
}_attribute[p.i].dirty=1,_attribute[p.i].boundary[right]=_boundary0,_attribute[p.i].boundary_homogeneous[right]=_boundary0_homogeneous;_attribute[p.i].dirty=1,_attribute[p.i].boundary[left]=_boundary1,_attribute[p.i].boundary_homogeneous[left]=_boundary1_homogeneous;_attribute[p.i].dirty=1,_attribute[p.i].boundary[top]=_boundary2,_attribute[p.i].boundary_homogeneous[top]=_boundary2_homogeneous;_attribute[p.i].dirty=1,_attribute[p.i].boundary[bottom]=_boundary3,_attribute[p.i].boundary_homogeneous[bottom]=_boundary3_homogeneous;_attribute[u.x.i].dirty=1,_attribute[u.x.i].boundary[left]=_boundary4,_attribute[u.x.i].boundary_homogeneous[left]=_boundary4_homogeneous;_attribute[u.y.i].dirty=1,_attribute[u.y.i].boundary[left]=_boundary5,_attribute[u.y.i].boundary_homogeneous[left]=_boundary5_homogeneous;_attribute[u.x.i].dirty=1,_attribute[u.x.i].boundary[right]=_boundary6,_attribute[u.x.i].boundary_homogeneous[right]=_boundary6_homogeneous;_attribute[u.y.i].dirty=1,_attribute[u.y.i].boundary[right]=_boundary7,_attribute[u.y.i].boundary_homogeneous[right]=_boundary7_homogeneous;_attribute[u.x.i].dirty=1,_attribute[u.x.i].boundary[top]=_boundary8,_attribute[u.x.i].boundary_homogeneous[top]=_boundary8_homogeneous;_attribute[u.y.i].dirty=1,_attribute[u.y.i].boundary[top]=_boundary9,_attribute[u.y.i].boundary_homogeneous[top]=_boundary9_homogeneous;_attribute[u.x.i].dirty=1,_attribute[u.x.i].boundary[bottom]=_boundary10,_attribute[u.x.i].boundary_homogeneous[bottom]=_boundary10_homogeneous;_attribute[u.y.i].dirty=1,_attribute[u.y.i].boundary[bottom]=_boundary11,_attribute[u.y.i].boundary_homogeneous[bottom]=_boundary11_homogeneous;_attribute[u.x.i].dirty=1,_attribute[u.x.i].boundary[embed]=_boundary12,_attribute[u.x.i].boundary_homogeneous[embed]=_boundary12_homogeneous;_attribute[u.y.i].dirty=1,_attribute[u.y.i].boundary[embed]=_boundary13,_attribute[u.y.i].boundary_homogeneous[embed]=_boundary13_homogeneous;_attribute[p.i].dirty=1,_attribute[p.i].boundary[right]=_boundary14,_attribute[p.i].boundary_homogeneous[right]=_boundary14_homogeneous;_attribute[pf.i].dirty=1,_attribute[pf.i].boundary[right]=_boundary15,_attribute[pf.i].boundary_homogeneous[right]=_boundary15_homogeneous;_attribute[p.i].dirty=1,_attribute[p.i].boundary[top]=_boundary16,_attribute[p.i].boundary_homogeneous[top]=_boundary16_homogeneous;_attribute[pf.i].dirty=1,_attribute[pf.i].boundary[top]=_boundary17,_attribute[pf.i].boundary_homogeneous[top]=_boundary17_homogeneous;_attribute[p.i].dirty=1,_attribute[p.i].boundary[bottom]=_boundary18,_attribute[p.i].boundary_homogeneous[bottom]=_boundary18_homogeneous;_attribute[pf.i].dirty=1,_attribute[pf.i].boundary[bottom]=_boundary19,_attribute[pf.i].boundary_homogeneous[bottom]=_boundary19_homogeneous;_attribute[f.i].dirty=1,_attribute[f.i].boundary[left]=_boundary20,_attribute[f.i].boundary_homogeneous[left]=_boundary20_homogeneous;_attribute[f.i].dirty=1,_attribute[f.i].boundary[right]=_boundary21,_attribute[f.i].boundary_homogeneous[right]=_boundary21_homogeneous;  
...
#line 455 "blur-ibm.c"
event_register((Event){0,1,adapt_0,{adapt_0_expr0},((int *)0),((double *)0),"blur-ibm.c",455,"adapt"});
